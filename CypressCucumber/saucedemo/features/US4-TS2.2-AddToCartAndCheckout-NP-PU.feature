Feature: Add to Cart and Checkout - Negative Path - Problem User

Scenario: User adds an item to the cart and proceeds to checkout as a problem user, then removes the item from the cart
