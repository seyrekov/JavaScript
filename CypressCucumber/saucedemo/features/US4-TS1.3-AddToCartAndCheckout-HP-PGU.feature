Feature: Add to Cart and Checkout - Happy Path - Performance Glitch User

Scenario: User adds an item to the cart and proceeds to checkout as a performance glitch user
