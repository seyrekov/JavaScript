...
When('I confirm the password {string}', async function (passwordConfirmation) {
  await driver.findElement(By.id("password-confirmation")).click();
  await driver.findElement(By.id("password-confirmation")).sendKeys(passwordConfirmation);
});
...
Then('I should be redirected to the welcome page for the new registered customer', async function () {
  const currentUrl = await driver.getCurrentUrl();
  assert.strictEqual(currentUrl, "https://magento.softwaretestingboard.com/customer/account/");
});
