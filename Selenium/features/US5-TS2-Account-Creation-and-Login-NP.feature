...
Scenario: Test that users can not create accounts when all necessary inputs were not done (negative path).
...
Then they should not be redirected to the home page of the registered customer